...
register(
    id='Plane-v1',
    entry_point='gym.envs.classic_control:PlaneEnv',
    reward_threshold=-100.0,
...
register(
    id='AntSpace-v1',
    entry_point='gym.envs.mujoco.ant_space:AntEnv',
    max_episode_steps=200,
    reward_threshold=6000.0,
)
...
register(
    id='AntGoal-v1',
    entry_point='gym.envs.mujoco.ant_goal:AntEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
register(
    id='AntRun-v1',
    entry_point='gym.envs.mujoco.ant_run:AntEnv',
    max_episode_steps=200,
    reward_threshold=6000.0,
)
...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchPickAndPlaceJointSpace{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceJointSpaceEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchPickAndPlacePosServo{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlacePosServoEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='FetchReachJointSpace{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachJointSpaceEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='FetchPushPrimitives{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushPrimitivesEnv',
        kwargs=kwargs,
        max_episode_steps=10,
    )

    register(
        id='FetchBarrierPrimitives{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchBarrierPrimitivesEnv',
        kwargs=kwargs,
