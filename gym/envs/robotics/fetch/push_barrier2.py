...
MODEL_XML_PATH = os.path.join('fetch', 'push_barrier2.xml') # trying this


class FetchBarrier2PrimitivesEnv(fetch_primitives_env.FetchPrimitivesEnv, utils.EzPickle):
