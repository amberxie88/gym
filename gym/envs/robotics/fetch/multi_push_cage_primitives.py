...
MODEL_XML_PATH = os.path.join('fetch', 'multi_push_cage_primitives.xml')


class MultiPushCagePrimitivesEnv(fetch_primitives_env.FetchPrimitivesEnv, utils.EzPickle):
