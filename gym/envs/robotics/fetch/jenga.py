...
from gym.envs.robotics import fetch_jenga_env
import numpy as np


# Ensure we get the path separator correct on windows
MODEL_XML_PATH = os.path.join('fetch', 'jenga.xml')


class FetchJengaEnv(fetch_jenga_env.FetchJengaEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        fetch_jenga_env.FetchJengaEnv.__init__(
