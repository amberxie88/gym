...
from gym.envs.robotics import fetch_pos_servo_env
import numpy as np


# Ensure we get the path separator correct on windows
MODEL_XML_PATH = os.path.join('fetch', 'pick_and_place_pos_servo.xml')


class FetchPickAndPlacePosServoEnv(fetch_pos_servo_env.FetchPosServoEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        fetch_pos_servo_env.FetchPosServoEnv.__init__(
